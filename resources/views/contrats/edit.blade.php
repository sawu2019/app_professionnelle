...
@section('content')
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Contrats<small>Modification</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form method="POST" action="{{ route('contrats.update', $contrat->id) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                    @method('PATCH')
                    @csrf
