@extends('layouts.app')
@section('title', 'Convention Miniers')

@section('content')

                <div class="x_panel">
                  <div class="x_title">
                  <h2>Contrats <small>La liste des conventions des opérateurs minier oeuvrant en République démocratique du Congo</small></h2>
