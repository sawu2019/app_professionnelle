...
<div class="x_panel">
  <div class="x_title">
    <h2>Projet <small>Modification</small></h2>
  ...
  <div class="x_content">
    <br />
    <form method="POST" action="{{ route('projets.update', $projet->id) }}" data-parsley-validate class="form-horizontal form-label-left">
    @method('PATCH')
      @csrf 
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="nom" name="nom" required="required" class="form-control has-feedback-left" value={{ $projet->nom }}>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <select class="form-control has-feedback-left @error('permi_id') is-invalid @enderror" name="permi_id">
            ...
            <option value="{{ $permi->id }}" {{ $projet->permi_id == $permi->id ? 'selected' : '' }}> {{ $permi->nom }}</option>
            @endforeach
          </select>
          @error('permi_id')
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <select class="form-control has-feedback-left @error('stade_id') is-invalid @enderror" name="stade_id">
            ...
            <option value="{{ $stade->id }}" {{ $projet->stade_id == $stade->id ? 'selected' : '' }}> {{ $stade->nom }}</option>
            @endforeach
          </select>
          @error('stade_id')
          <div class="invalid-feedback">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <select class="form-control has-feedback-left @error('tprojet_id') is-invalid @enderror" name="tprojet_id">
            ...
            <option value="{{ $tprojet->id }}" {{ $projet->tprojet_id == $tprojet->id ? 'selected' : '' }}>  {{ $tprojet->nom }}</option>
            @endforeach
          </select>
          @error('tprojet_id')
          <div class="invalid-feedback">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <select class="form-control has-feedback-left @error('operat_id') is-invalid @enderror" name="operat_id">
            ...
            <option value="{{ $operat->id }}" {{ $projet->operat_id == $operat->id ? 'selected' : '' }}> {{ $operat->sigle }}</option>
            @endforeach
          </select>
          @error('operat_id')
          <div class="invalid-feedback">
