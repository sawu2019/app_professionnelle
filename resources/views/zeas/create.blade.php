...
<div class="x_panel">
  ...
  <div class="x_content">
    <br />
    <form action="{{ route('zeas.store') }}" method="post" data-parsley-validate class="form-horizontal form-label-left">
      @csrf
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="filie" name="filie" required="required" class="form-control has-feedback-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="narrete" name="narrete" required="required" class="form-control has-feedback-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="qualification" name="qualification" required="required" class="form-control has-feedback-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="transformation" name="transformation" required="required" class="form-control has-feedback-left">
