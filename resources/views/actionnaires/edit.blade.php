...
<div class="x_panel">
  <div class="x_title">
    <h2>Actionnaire <small>Modifier</small></h2>
    ...
    <form method="POST" action="{{ route('actionnaires.update', $actionnaire->id) }}" method="post" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="nom" name="nom" required="required" class="form-control has-feedback-left" value={{ $actionnaire->nom }}>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="prenom" name="prenom" required="required" class="form-control has-feedback-left" value={{ $actionnaire->prenom }}>
