...
@section('content')
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="POST" action="{{ route('arretes.update', $arrete->id) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                    @method('PATCH')
                    @csrf
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="titre" name="titre" required="required" class="form-control has-feedback-left" value={{ $arrete->titre }}>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control has-feedback-left @error('operat_id') is-invalid @enderror"  name="operat_id">
                            ...
                            <option value="{{ $operat->id }}" {{ $arrete->operat_id == $operat->id ? 'selected' : '' }}> {{ $operat ->sigle }}</option>
                            @endforeach
                          </select>
                          @error('operat_id')
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control has-feedback-left @error('typearrete_id') is-invalid @enderror"  name="typearrete_id">
                            ...
                            <option value="{{ $typearrete->id }}" {{ $arrete->typearrete_id == $typearrete->id ? 'selected' : '' }}> {{ $typearrete ->nom }}</option>
                            @endforeach
                          </select>
                          @error('typearrete_id')
                          <div class="invalid-feedback">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="fichier" name="fichier" required="required" class="form-control has-feedback-left" value={{ $arrete->fichier }}>
