...
<div class="x_panel">
  ...
  <div class="x_content">
    <br />
    <form method="POST" action="{{ route('titrems.update', $titrem->id) }}" data-parsley-validate class="form-horizontal form-label-left">
      @method('PATCH')
      @csrf
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <select class="form-control has-feedback-left @error('operat_id') is-invalid @enderror" name="operat_id">
            ...
            <option value="{{ $operat->id }}" {{ $operat->operat_id == $operat->id ? 'selected' : '' }}> {{ $operat ->sigle }}</option>
            @endforeach
          </select>
          @error('operat_id')
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="permis" name="permis" required="required" class="form-control has-feedback-left" value={{ $titrem->permis }}>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="titusite" name="titusite" required="required" class="form-control has-feedback-left" value={{ $titrem->titusite }}>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="typepermis" name="typepermis" required="required" class="form-control has-feedback-left" value={{ $titrem->typepermis }}>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="carrem" name="carrem" required="required" class="form-control has-feedback-left" value={{ $titrem->carrem }}>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="localisation" name="localisation" required="required" class="form-control has-feedback-left" value={{ $titrem->localisation }}>
          <span class="fa fa-magic form-control-feedback left" aria-hidden="true"></span>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="date" id="dateoctroi" name="dateoctroi" required="required" class="form-control has-feedback-left" value={{ $titrem->dateoctroi }}>
          <span class="fa fa-magic form-control-feedback left" aria-hidden="true"></span>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="date" id="dateexp" name="dateexp" required="required" class="form-control has-feedback-left" value={{ $titrem->dateexp }}>
          <span class="fa fa-magic form-control-feedback left" aria-hidden="true"></span>
        </div>
      </div>
